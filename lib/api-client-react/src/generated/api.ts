...
export const updateMyLocation = async (
  ...
  return customFetch<void>(getUpdateMyLocationUrl(), {
    ...options,
    method: "PUT",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(userLocationInput),
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<UserLocationInput> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type UpdateMyLocationMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateMyLocation>>
>;
export type UpdateMyLocationMutationBody = BodyType<UserLocationInput>;
